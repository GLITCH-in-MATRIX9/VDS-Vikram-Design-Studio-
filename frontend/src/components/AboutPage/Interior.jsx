  ...
  return (
    <section className="px-4 sm:px-6 lg:px-20 py-10 sm:py-16 bg-[#f3efee] text-[#3E3C3C]">
      <div className="  mx-auto">
        {/* Big title to introduce our interior design team! */}
        <motion.h1
        ...
        >
          <p>
            Interior design at VDS is guided by precision, emotion, and
            experience. From refined villas and boutique hotels to institutional
            interiors, we approach every project with a deep understanding of
            how space feels from within. Our interiors are both functional and
            poetic—where circulation flows naturally, materiality is expressive,
            and lighting is treated as atmosphere, not afterthought.
          </p>
          <p>
            We work with carefully chosen palettes and long-lasting finishes,
            equally attentive to high-end detailing and practical durability.
            Whether we’re designing a compact government office or a luxury
            guest suite, we believe the inside of a space should reveal its
            essence. Every line, surface, and shadow contribute to a coherent,
            human-centric environment that’s built to be used, remembered, and
            returned to.
          </p>
        </motion.div>

        {/* Here come the cards! You can scroll through them to meet our interior collaborators. */}
        <motion.div
          className="relative"
        ...
        >
          ...
          {/* Each card shows an interior partner's photo and a short story about them */}
          <div
            ref={scrollRef}
