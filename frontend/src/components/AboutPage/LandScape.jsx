  ...
  return (
    <section className="px-4 sm:px-6 lg:px-20 py-10 sm:py-16 bg-[#f3efee] text-[#3E3C3C]">
      <div className="  mx-auto">
        ...
        {/* Here come the cards! You can scroll through them to meet our landscape collaborators. */}
        <motion.div
          className="relative"
        ...
        >
          ...
          {/* Each card shows a landscape partner's photo and a short story about them */}
          <div
            ref={scrollRef}
