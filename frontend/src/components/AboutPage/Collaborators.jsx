  ...
  return (
    <section className="px-4 sm:px-6 lg:px-20 py-10 sm:py-16 bg-[#f3efee] text-[#3E3C3C]">
      <div className="max-w-screen-xl mx-auto">
        {/* Big title to introduce our collaborators! */}
        <motion.h1
        ...
        {/* Here come the cards! You can scroll through them to meet our collaborators. */}
        <motion.div
          className="relative"
        ...
        >
          ...
          {/* Each card shows a collaborator's photo and a short story about them */}
          <div
            ref={scrollRef}
