...
const API_URL = "http://localhost:5000/api/projects"; // replace with your backend
const USER_API = "http://localhost:5000/api/auth/profile"; // Corrected route
    ...
    <div className="p-10 bg-[#f3efee] min-h-screen relative">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 flex-1">
          ...
          <StatCard value={stats.positions} label="Positions Open : Categories" />
