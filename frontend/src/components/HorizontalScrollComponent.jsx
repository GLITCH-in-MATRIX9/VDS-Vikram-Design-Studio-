    ...
    <div className="relative w-full font-inter min-h-[520px] overflow-hidden">
      ...
      <div className="absolute top-4 left-4 flex items-center gap-2 z-20 sm:top-5 sm:left-5 sm:gap-3">
        ...
        <button
          ...
          className="group relative flex items-center justify-start rounded-full border border-gray-400 bg-white hover:bg-[#2B2624B2] hover:text-[#faf6f3] text-gray-400 w-9 sm:w-10 hover:w-40 sm:hover:w-44 h-9 sm:h-10 transition-all duration-300 overflow-hidden text-xs"
        >
          <div className="absolute left-0 top-0 w-9 sm:w-10 h-9 sm:h-10 flex items-center justify-center">
            <FiArrowRight
              size={20}
              className="transition-all duration-100 group-hover:mr-2"
            />
          </div>
          <span className="opacity-0 group-hover:opacity-100 text-xs font-semibold duration-300 whitespace-nowrap group-hover:text-[#faf6f3] pl-10 pr-3 sm:pr-4">
            VIEW ENTIRE PROJECT
          </span>
        </button>
      </div>
