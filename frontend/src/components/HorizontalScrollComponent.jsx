...
const HorizontalScrollComponent = ({ onClose, project }) => {
  ...
  return (
    <div className="relative w-full font-inter overflow-hidden">
      ...
      >
        <img src={LeftArrowIcon} alt="" className="w-4" />
      </button>
      ...
      >
        <motion.div
          ref={contentRef}
          className="flex items-start" // Use flex to lay out children horizontally
          // Animate the 'x' property based on our state
          animate={{ x: xOffset }}
          transition={transition} // Use the dynamic transition state
        >
