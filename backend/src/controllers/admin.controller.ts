...
/* ABOUT PAGE MANAGEMENT
   Implementations are in `about.controller.ts`. We re-export those
   functions above so admin routes can continue importing them from
   admin.controller for convenience. */
