...
router.post('/', protect, requireRole(['admin', 'super_admin']), upload.single('preview'), uploadToCloudinary, createProject);
router.put('/:id', protect, requireRole(['admin', 'super_admin']), upload.single('preview'), uploadToCloudinary, updateProject);
